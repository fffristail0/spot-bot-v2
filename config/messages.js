...
`.trim()
  ...
  filters: {
    ...
    ownership: 'Какие споты показывать?',
    ownershipOptions: { all: 'Все', owner: 'Мои', shared: 'Мне расшарили' },
    hasGps: 'Фильтр по координатам',
    hasGpsOptions: { any: 'Любые', yes: 'Только с координатами', no: 'Только без координат' },
    period: 'За какой период?',
    periodOptions: { all: 'За всё время', d7: '7 дней', d30: '30 дней', d90: '90 дней' },
    text: 'Введите поисковую строку или нажмите «Пропустить».',
    skip: 'Пропустить',
    saved: '✅ Фильтр сохранён. Показаны свежие результаты.',
    resetOk: '♻️ Фильтры сброшены.'
  },
  ...
  list: {
    ...
    share: '📤 Поделиться',
    delete: '🗑️ Удалить',
    header: 'Найдено: {{TOTAL}}. Показаны {{FROM}}–{{TO}} (шаг {{STEP}}). {{FILTERS}}',
    nav: {
      prev: '◀️ Назад',
      next: 'Дальше ▶️',
      filters: '🔎 Фильтры',
